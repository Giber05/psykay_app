...
class PsykayDropdown<T> extends StatefulWidget {
  final List<(String label, T data)> choices;
  final T? initialValue;
  final PsykayDropdownController? controller;
  final String label;
  ...
  @override
  State<PsykayDropdown<T>> createState() => _PsykayDropdownState<T>();
}

class PsykayDropdownController<T> {
  _PsykayDropdownState<T>? _state;
  PsykayDropdownController();

  _init(_PsykayDropdownState<T>? state) {
    _state = state;
  }
...
class _PsykayDropdownState<T> extends State<PsykayDropdown<T>> {
  T? _value;
