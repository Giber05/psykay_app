...
import 'package:psykay_app/modules/authentication/data/mapper/local/session_local_mapper.dart';
...
class AuthLocalDTSImpl implements AuthenticationLocalDTS {
  ...
  final _userSessionKey =
      "psykay.app.lib.modules.authentication.data.datasource.local.authentication_local_dts.dart";
